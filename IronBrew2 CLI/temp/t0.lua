...
local function benchmark()
   ...
   print("Benchmarking (calculating SHA512 of 10KByte string of letters 'a')...")

   local a = os.clock()
   local time_intervals = {}

   local length = 2^10*10
   local part = ("a"):rep(2^6)
   local N = length/#part
   local result
   ...
   print('CPU seconds (average per cycle):', time_intervals[k])
   print('CPU seconds (total):', os.clock() - a)
